...
function copyAndConvertFramebuffer() {
  ...
  return ({gl, framebuffer}) => {
    ...
    if (i420DeviceBuffer?.byteLength !== i420ByteLength) {
      i420HostBuffer   = new Uint8Array(i420ByteLength);
    ...
    i420DeviceBuffer.copyInto(i420HostBuffer);

    return {width, height, data: i420HostBuffer.buffer};
  };
}
